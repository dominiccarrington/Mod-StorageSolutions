...
import com.ragegamingpe.storagesolutions.common.block.te.base.TEBasicInventory;
...
public abstract class ModBlockInventory extends ModBlockContainer
{
    ...
    {
        if (!worldIn.isRemote) {
            playerIn.openGui(StorageSolutions.instance, getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
