package com.ragegamingpe.storagesolutions.common.block.te.base;
...
public class TEBasicInventory extends TileEntity implements IInventory
{
    ...
    public ITextComponent getDisplayName()
    {
        return this.hasCustomName()
                ...
                : new TextComponentTranslation(String.format("container.%s:%s.name", StorageSolutions.MODID, this.name));
    }
